...
add_filter( 'gform_field_value_gfreferrer', 'gfreferrer_get_referral_source' );
function gfreferrer_get_referral_source( $value ) {
  //echo $_SESSION['gf_referral_source'].'<br/>';
  if (isset($_SESSION['gf_referral_source']) && !empty($_SESSION['gf_referral_source'])) {
